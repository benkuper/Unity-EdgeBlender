...
namespace Spout{
	[Serializable]
	public class SpoutCamSender : MonoBehaviour {
		...
		void OnGUI()
		{
			...
			{
				GUI.DrawTexture(new Rect(_cam.rect.x*Screen.width,_cam.rect.y*Screen.height,_cam.rect.width*Screen.width,_cam.rect.height*Screen.height), texture,ScaleMode.ScaleToFit,false);
			}
		}
